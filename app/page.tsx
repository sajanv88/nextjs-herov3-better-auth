import { Button, Card, CardHeader, CardDescription, CardContent } from "@heroui/react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                <NextLink href="#features" className="text-white hover:text-gray-300 transition-colors">
                  Features
                </NextLink>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <section id="features" className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent>
                  <CardDescription className="text-gray-300">
                    Built with performance in mind. Load your websites in milliseconds.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent>
                  <CardDescription className="text-gray-300">
                    Your websites are encrypted and secure with enterprise-grade security.
                  </CardDescription>
                </CardContent>
              </Card>
            </section>
